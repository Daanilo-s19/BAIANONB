...
class Apartamento extends Imovel {
    ...
    protected $suite, $elevador;

    public function __construct($nome, $imagem, $sala, $quarto, $cozinha, $banheiro, $disp, $piscina, $estacionamento, $elevador, $suite, $valor, $tipo, $local, $checkIn, $checkOut, $hospedes) {
    ...
    public function exibirImovel() {
     ...
     public function imagem() {
      parent::imagem();
    echo " 
    <p><b>TOTAL DE ELEVADOR:</b> {$this->getElevador()}</p>
    <p><b>TOTAL DE SUITE:</b> {$this->getSuite()}</p>";     
