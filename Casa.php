...
class Casa extends Imovel {
    ...
    public function __construct($nome, $imagem, $sala, $quarto, $cozinha, $banheiro, $disp, $piscina, $estacionamento, $valor, $quintal, $tipo, $local, $checkIn, $checkOut, $hospedes) {
        parent::__construct($nome, $imagem, $sala, $quarto, $cozinha, $banheiro, $disp, $piscina, $estacionamento, $valor, $tipo, $local, $checkIn, $checkOut, $hospedes);
    ...
    public function imagem() {
        parent::imagem();
        echo "<p><b>QUINTAL:</b>{$this->getQuintal()}</p>";
    }
    ...
    public function setQuintal($quintal) {
        $this->quintal = $quintal;
    }
