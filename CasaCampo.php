...
class CasaCampo extends Casa {
    protected $vegetacao, $animais;
    
    public function __construct($nome, $imagem, $sala, $quarto, $cozinha, $banheiro, $disp, $piscina, $estacionamento, $valor, $quintal,$vegetacao,$animais, $tipo, $local, $checkIn, $checkOut, $hospedes) {
        parent::__construct($nome, $imagem, $sala, $quarto, $cozinha, $banheiro, $disp, $piscina, $estacionamento, $valor, $quintal, $tipo, $local, $checkIn, $checkOut, $hospedes);
  ...
  echo "<div class = \"col-sm-4\">
                            ...
                            <div class=\"single-products\">
                                <div class=\"productinfo text-center\">
                                    ...
                                    <p>{$this->getNome()}</p>                        
                                       ...
                                       <input type=\"hidden\" name=\"dmagem\" id=\"imagem\" value=\"{$this->getImagem()}\">
                                       ...
                                       <input type=\"hidden\" name=\"quintal\" id=\"quintal\" value=\"{$this->getQuintal()}\"> 
                                       <input type=\"hidden\" name=\"vegetacao\" id=\"vegetacao\" value=\"{$this->getVegetacao()}\"> 
                                       <input type=\"hidden\" name=\"animal\" id=\"animal\" value=\"{$this->getAnimais()}\"> 
    ...
    public function imagem(){
        parent::imagem();
        echo " 
            <p><b>FLORA:</b>{$this->getVegetacao()}</p>
            <p><b>FAUNA:</b>{$this->getAnimais()}</p>";
